...
class Tokenizer {
    ...
    dispatch(char) {
        ...
        if (Suffix_1.Suffix.Suffix.has(char)) {
            return char === '.' ? new DotAfter() : new Suffix_1.Suffix(Suffix_1.Suffix.SuffixDict[char]);
        }
        ...
        if (char === '^') {
            ...
            if (next !== ')') {
                ...
                this.incPointer();
                return new AppoggiaturaBound(TokenType_1.PairType.Right);
            }
        }
        // Chord
        if (char === '&') {
        ...
        if (char === '(') {
            ...
            if (tup) {
                if (tup.endsWith('^')) {
                    ...
                    return new AppoggiaturaBound(TokenType_1.PairType.Left);
                }
                else {
                    if (tup.isNumeric()) {
