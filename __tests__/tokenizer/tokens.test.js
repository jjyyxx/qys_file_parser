describe('Test all tokens', () => {
    ...
    it('deals with Appoggiatura correctly', () => {
        ...
        expect(result[0].type).toBe(TokenType.Appoggiatura)
        expect(result[0].notes).toHaveLength(1)
        expect(result[0].notes[0].oriPitchLiteral).toBe(1)
    })
    ...
    it('deals with Chord correctly', () => {
        ...
        const result = tokenizer.tokenize()
        expect(result).toHaveLength(1)
        expect(result[0].type).toBe(TokenType.Chord)
    ...
    it('deals with Comment correctly', () => {
        ...
        expect(result[0].type).toBe(TokenType.Note)
        expect(result[0].oriPitchLiteral).toBe(1)
        expect(result[1].type).toBe(TokenType.Comment)
        expect(result[1].comment).toEqual('hehe')
        expect(result[2].type).toBe(TokenType.Note)
    ...
    it('deals with RepeatBound correctly', () => {
        ...
        expect(result[5].type).toBe(TokenType.Note)
